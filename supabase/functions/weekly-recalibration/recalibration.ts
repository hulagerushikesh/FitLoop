// Duplicated from app/src/engine/recalibration.ts — keep the two in
// sync if the algorithm changes. See that file for the unit-tested
// source of truth; this is a byte-for-byte copy adjusted only for
// Deno's explicit .ts import extensions.
import type { GoalType } from './types.ts';
import { MIN_SAFE_CALORIE_TARGET } from './calorieEngine.ts';
